(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ArtistaComponent = /** @class */ (function () {
                function ArtistaComponent(router, // servicio de router
                spotify) {
                    var _this = this;
                    this.router = router;
                    ...
                    this.router.params.subscribe(function (params) {
                        _this.getArtista(params['id']); // llegar al id del artista
            ...
            var HomeComponent = /** @class */ (function () {
                function HomeComponent(spotify) {
                    ...
                    this.spotify.getNewReleases() //llama al servicio
                        ...
                        _this.nuevasCanciones = data.albums.items; // nuevas canciones = Data
                        _this.loading = false; // ya  no muestra la data
                    });
                }
            ...
            var SearchComponent = /** @class */ (function () {
                ...
                SearchComponent.prototype.buscar = function (termino) {
                    ...
                    this.spotify.getArtistas(termino) // recibe la data 
                        ...
                        _this.artistas = data.artists.item; // lo metemos todo en la var artustas
                    });
                };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var SpotifyService = /** @class */ (function () {
                ...
                SpotifyService.prototype.getNewReleases = function () {
                    ...
                    return this.http.get('https://api.spotify.com/v1/browse/new-releases', { headers: headers }); // enviar headers /*?limit=5*/
                    //filtrar info con
                };
                SpotifyService.prototype.getArtistas = function (termino) {
                    ...
                    return this.http.get("https://api.spotify.com/v1/search?type=" + termino + "&limit=15", { headers: headers });
                ...
                SpotifyService.prototype.getTopTracks = function (id) {
                    ...
                    return this.http.get("https://api.spotify.com/v1/artists/" + id + "/top-tracks?country=us", { headers: headers });
                };
